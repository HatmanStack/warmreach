"""RAGStack Lambda - Routes RAGStack search, ingest, and status operations."""
...
from shared_services.lambda_utils import get_user_id, report_telemetry
...
def _report_telemetry(user_id, operation, count=1):
    """Delegate to shared telemetry helper."""
