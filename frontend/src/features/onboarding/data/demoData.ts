...
export const DEMO_MESSAGES: DemoMessage[] = [
  {
    subject: 'Great talk at the React conf!',
    body: "Hi Sarah, I really enjoyed your talk on React Server Components at the conference last week. Your point about streaming SSR resonated with our team's approach. Would love to chat more about your experience scaling RSC in production.",
    connectionName: 'Sarah Chen',
    tone: 'professional',
  },
  {
    subject: 'Thoughts on your recent article',
    body: "Marcus, your article on product-led growth metrics was insightful. We're implementing a similar framework at our company. Would you be open to a quick 15-minute call to exchange notes?",
    connectionName: 'Marcus Johnson',
    tone: 'casual',
  },
  {
    subject: 'Intro request - AI safety research',
    body: "Hi Priya, I've been following your research on interpretable AI at Anthropic. I'm working on related problems in production ML systems and would value your perspective. Happy to share our learnings as well.",
    connectionName: 'Priya Patel',
    tone: 'professional',
  },
  {
    subject: 'Congrats on the funding round!',
    body: "Alex, congratulations on Linear's latest round! The improvements to the issue tracker have been a game-changer for our engineering team. Would love to connect and share feedback from our usage.",
    connectionName: 'Alex Rivera',
    tone: 'enthusiastic',
  },
];
...
export const DEMO_QUOTA_USAGE: Record<string, DemoQuotaStatus> = {
  generate_message: {
    allowed: true,
    remaining: 8,
    dailyLimit: 10,
