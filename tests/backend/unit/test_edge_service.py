...
class TestEdgeServiceUpsertStatus:
    ...
    def _make_service(self, **kwargs):
        """Helper to create EdgeService with mock table and client."""
        mock_table = MagicMock()
        mock_table.table_name = 'test-table'
        mock_client = MagicMock()
        return EdgeService(table=mock_table, dynamodb_client=mock_client, **kwargs), mock_table, mock_client

    def test_upsert_status_creates_edges(self):
        """Should create both edges via transact_write_items."""
