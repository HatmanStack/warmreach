...
export const postSelectors: SelectorRegistry = {
    ...
    'post:content-editor': [
        ...
        { strategy: 'placeholder-full', selector: 'div[data-placeholder*="What do you want to talk about"]' },
    ...
    'post:media-upload': [
        ...
        { strategy: 'css-aria', selector: '.share-actions__primary-action button[aria-label*="media"]' },
        { strategy: 'data-control', selector: 'button[data-control-name="add_media"]' },
    ],
    'post:upload-input': [
        { strategy: 'aria', selector: 'button[aria-label*="Upload"]' },
    ],
    'post:media-button': [
    ...
    'post:follow-button': [
        ...
        { strategy: 'aria-not-following', selector: '[aria-label*="Follow" i]:not([aria-label*="Following" i])' },
        { strategy: 'button-aria-not', selector: 'button[aria-label*="Follow" i]:not([aria-label*="Following" i])' },
    ...
    'post:follow-from-menu': [
        ...
        { strategy: 'css-dropdown', selector: '.artdeco-dropdown__content button[aria-label*="Follow"]' },
        { strategy: 'data-test-menu', selector: '[data-test-id="overflow-menu"] button[aria-label*="Follow"]' },
    ],
};
