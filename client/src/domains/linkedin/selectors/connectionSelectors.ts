...
export const connectionSelectors: SelectorRegistry = {
  ...
  'connection:more-button': [{ strategy: 'aria', selector: 'button[aria-label*="More"]' }],
  'connection:add-note': [{ strategy: 'text', selector: 'button:has-text("Add a note")' }],
  'connection:note-input': [{ strategy: 'element', selector: 'textarea' }],
