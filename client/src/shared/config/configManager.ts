...
export class ConfigManager {
  ...
  static configCache: Map<string, unknown> = new Map();
  static lastValidation: ValidationResult | null = null;
  static configWatchers: Set<ConfigWatcherCallback> = new Set();
   ...
   */
  cacheFrequentlyUsedConfig(): void {
   ...
   */
  setupConfigurationMonitoring(): void {
   ...
   */
  getOperationConfig(operationType: string): Record<string, unknown> {
    const baseConfig = {
   ...
   */
  getHumanBehaviorConfig(): Record<string, unknown> {
    return {
   ...
   */
  getTimeoutConfig(): Record<string, unknown> {
    return {
   ...
   */
  getEnvironmentConfig(): Record<string, unknown> {
   ...
   */
  addConfigWatcher(callback: ConfigWatcherCallback): void {
   ...
   */
  removeConfigWatcher(callback: ConfigWatcherCallback): void {
   ...
   */
  notifyConfigWatchers(event: string, data: unknown): void {
  ...
  getHealthStatus(): Record<string, unknown> {
    const validation: ValidationResult = this.lastValidation || {
      isValid: false,
